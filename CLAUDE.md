...
| Hacer `fetch`/scraping a un dominio que no esté en la lista administrable `babel-sitios-scraping`, o sin pasar por la guardia SSRF fija (`esUrlSegura`: HTTPS + host público) | Abre la puerta a SSRF |
